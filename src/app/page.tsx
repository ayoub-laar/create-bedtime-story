    ...
    <FormStepProvider>
      <FormProvider>
        <div className="flex items-center justify-center mt-8 mx-auto">
          <span className="text-pink-400 text-sm rounded-full py-2 px-4 inline-flex items-center" style={{ backgroundColor: 'rgba(100, 0, 128, 0.2)' }}>
            <span className="mr-2">Powered by</span>
            <svg className="h-5 w-auto text-pink-400 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1180 320">
